...
// Identidad de marca: watermark numérico (01/02/03) + BrandLines por beat.
// ─────────────────────────────────────────────────────────────────────────────
      ...
      <div className="mx-auto grid max-w-landing items-center gap-12 px-6 md:grid-cols-2 md:gap-20">
        ...
        <ScrollReveal direction="left">
          <div className="relative">
            <span
              className="pointer-events-none absolute -top-2 right-0 select-none font-display leading-none text-[var(--t1)] opacity-[0.06]"
              style={{ fontSize: "clamp(6rem, 18vw, 12rem)" }}
              aria-hidden="true"
            >
              01
            </span>
            <p className="mb-3 font-condensed text-xs font-bold tracking-[4px] text-[var(--t3)]">01 / 03</p>
            <BrandLines animated className="mb-6" />
            <p className="mb-4 font-condensed text-xs font-bold uppercase tracking-[3px] text-[var(--p1)]">{beat.eyebrow}</p>
            <h2 className="mb-6 font-display leading-none text-[var(--t1)]" style={{ fontSize: "clamp(3rem, 9vw, 7rem)" }}>
              {beat.headlinePre}{" "}<span className="text-[var(--p1)]">{beat.headlineAccent}</span>
            </h2>
            <p className="font-sans text-xl leading-relaxed text-[var(--t2)]">{beat.body}</p>
          </div>
        </ScrollReveal>
      ...
      <div className="mx-auto grid max-w-landing items-center gap-12 px-6 md:grid-cols-2 md:gap-20">
        ...
        <ScrollReveal direction="right">
          <div className="relative">
            ...
            <p className="mb-3 font-condensed text-xs font-bold tracking-[4px] text-[var(--t3)]">02 / 03</p>
            <BrandLines animated className="mb-6" />
            <p className="mb-4 font-condensed text-xs font-bold uppercase tracking-[3px] text-[var(--p2)]">{beat.eyebrow}</p>
            <h2 className="mb-6 font-display leading-none text-[var(--t1)]" style={{ fontSize: "clamp(3rem, 9vw, 7rem)" }}>
              {beat.headlinePre}{" "}<span className="text-[var(--p2)]">{beat.headlineAccent}</span>
            </h2>
            <p className="font-sans text-xl leading-relaxed text-[var(--t2)]">{beat.body}</p>
          </div>
        </ScrollReveal>
      ...
      <div className="mx-auto max-w-landing px-6">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <div className="relative z-10 py-32 md:py-44">
            ...
            <span
              className="pointer-events-none absolute -top-4 left-1/2 -translate-x-1/2 select-none font-display leading-none text-[var(--t1)] opacity-[0.05]"
            ...
            <ScrollReveal direction="up">
              <p className="mb-3 font-condensed text-xs font-bold tracking-[4px] text-[var(--t3)]">03 / 03</p>
              <BrandLines animated centered className="mb-6 mx-auto max-w-[260px]" />
              <p className="mb-4 font-condensed text-xs font-bold uppercase tracking-[3px] text-[var(--p1)]">{beat.eyebrow}</p>
            </ScrollReveal>

            <ScrollReveal direction="up" delay={100}>
              <h2 className="mb-2 font-display leading-none text-[var(--t1)]" style={{ fontSize: "clamp(3rem, 9vw, 7rem)" }}>
                {beat.headlinePre}{" "}<span className="text-[var(--p1)]">{beat.headlineAccent}</span>
              </h2>
            </ScrollReveal>

            <ScrollReveal direction="up" delay={180}>
              <p className="mb-8 font-display leading-none text-[var(--t2)]" style={{ fontSize: "clamp(1.5rem, 4vw, 3rem)" }}>
                {beat.headlineSub}
              </p>
            </ScrollReveal>
